...
public class StaffScheduler {
	...
	public void scheduleStaff() {
		...
		try {
			int totalHours = 0;
			File inputFile = new File("staff_availability_IN.txt");
			PrintWriter outputFile = new PrintWriter("store_schedule_OUT.txt");
			File shiftFile = new File("shift_schedules_IN.txt");
